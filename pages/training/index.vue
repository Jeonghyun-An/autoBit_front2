            ...
            <div class="p-6 pb-4 border-b border-zinc-200">
              ...
              <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    class="px-3 py-1.5 text-xs rounded-md border border-zinc-300 text-zinc-600 hover:bg-slate-800 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-1.5"
      ...
      >
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="flex items-center justify-center px-3 py-2 rounded-lg hover:bg-zinc-100 transition-all"
          ...
          <div class="flex h-[70vh] min-h-[520px]">
            ...
            >
              ...
              <div class="flex items-center justify-between mb-4">
                ...
                <button
                  type="button"
                  class="px-3 py-2 text-xs rounded-lg bg-slate-900 text-white hover:bg-slate-800 transition-all flex items-center gap-2"
                  @click="
              ...
              >
                <div class="flex items-center gap-2">
                  <input
                    ...
                    type="text"
                    placeholder="폴더 이름"
                    class="flex-1 px-3 py-2 text-sm border border-zinc-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zinc-300"
                    @keyup.enter="createFolderInline"
                    @keyup.esc="cancelCreateFolder"
                  />
                  <button
                    type="button"
                    class="px-3 py-2 text-xs rounded-lg border border-zinc-300 text-zinc-600 hover:text-white hover:bg-slate-900 transition-all"
              ...
              <!-- 폴더 목록 스크롤 -->
              <div
                class="flex-1 overflow-y-auto p-1 space-y-2 scrollbar-zinc"
                style="scrollbar-gutter: stable"
              >
                <div
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex items-center justify-between gap-2">
                        <input
                          ...
                          type="text"
                          class="flex-1 px-2 py-1 text-sm font-semibold border border-zinc-300 rounded focus:outline-none focus:ring-2 focus:ring-zinc-300"
            ...
            <div class="flex-1 p-6 flex flex-col">
              ...
              <div class="mt-4 flex items-center justify-end gap-2">
                ...
                <button
                  type="button"
                  class="px-4 py-2 text-sm rounded-lg bg-slate-900 text-white hover:bg-slate-800 disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-2"
              ...
              <div class="mt-6 text-xs text-zinc-400 leading-relaxed">
                • "저장하기"는 선택된 문서를 폴더에
                <span class="text-zinc-600 font-semibold">추가</span>합니다
                (기존 문서는 유지).<br />
                • "이 폴더 불러오기"는 해당 폴더에 저장된 전체 문서를 선택된
                상태로 복원합니다.<br />
